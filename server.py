...
answers = [ 'd', 'a', 'b', 'a', 'a', 'a', 'b', 'a', 'c', 'b', 'd', 'd',
           'c', 'a', 'b', 'a' ]
...
def clientthread(conn):
    ...
    conn.send("You will recieve a question. The answer to that question should be of a, b, c, or d.".encode('utf-8'))
    conn.send("Good luck!\n\n".encode('utf-8'))
